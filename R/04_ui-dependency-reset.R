#------------------------------------------------------------------------------#
# status: 
# content of the whole app (menus + tab) depends on the content of data import tab
#   when df is selected the whole ui re renders which looses the current selection and resets everything
# 
...
#
# - insertUI seems to be exactly what is needed here, does it work with shinydashboard?
#
#------------------------------------------------------------------------------#
